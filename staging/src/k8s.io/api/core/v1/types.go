...
type NodeConfigStatus struct {
	...
	// +optional
	Active *NodeConfigSource `json:"active,omitempty" protobuf:"bytes,1,opt,name=active"`
	// Assigned is the node's ack of the config source assigned via Node.Spec.ConfigSource
	// +optional
	Assigned *NodeConfigSource `json:"assigned,omitempty" protobuf:"bytes,2,opt,name=assigned"`
