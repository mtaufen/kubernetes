...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_SerializedNodeConfigSource_To_core_SerializedNodeConfigSource,
		Convert_core_SerializedNodeConfigSource_To_v1_SerializedNodeConfigSource,
...
func autoConvert_v1_SerializedNodeConfigSource_To_core_SerializedNodeConfigSource(in *v1.SerializedNodeConfigSource, out *core.SerializedNodeConfigSource, s conversion.Scope) error {
	if err := Convert_v1_NodeConfigSource_To_core_NodeConfigSource(&in.Source, &out.Source, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_SerializedNodeConfigSource_To_core_SerializedNodeConfigSource is an autogenerated conversion function.
func Convert_v1_SerializedNodeConfigSource_To_core_SerializedNodeConfigSource(in *v1.SerializedNodeConfigSource, out *core.SerializedNodeConfigSource, s conversion.Scope) error {
	return autoConvert_v1_SerializedNodeConfigSource_To_core_SerializedNodeConfigSource(in, out, s)
}

func autoConvert_core_SerializedNodeConfigSource_To_v1_SerializedNodeConfigSource(in *core.SerializedNodeConfigSource, out *v1.SerializedNodeConfigSource, s conversion.Scope) error {
	if err := Convert_core_NodeConfigSource_To_v1_NodeConfigSource(&in.Source, &out.Source, s); err != nil {
		return err
	}
	return nil
}

// Convert_core_SerializedNodeConfigSource_To_v1_SerializedNodeConfigSource is an autogenerated conversion function.
func Convert_core_SerializedNodeConfigSource_To_v1_SerializedNodeConfigSource(in *core.SerializedNodeConfigSource, out *v1.SerializedNodeConfigSource, s conversion.Scope) error {
	return autoConvert_core_SerializedNodeConfigSource_To_v1_SerializedNodeConfigSource(in, out, s)
}
