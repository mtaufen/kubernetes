		...
		if false {
			...
			if yyr130 || yy2arr130 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF81234, string(x.KubeletConfigFile))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey1234)
				r.EncodeString(codecSelferC_UTF81234, string("kubeletConfigFile"))
				z.EncSendContainerState(codecSelfer_containerMapValue1234)
				yym470 := z.EncBinary()
				_ = yym470
				if false {
	...
	for yyj473 := 0; ; yyj473++ {
		...
		case "kubeletConfigFile":
			if r.TryDecodeAsNil() {
				...
				x.KubeletConfigFile = string(r.DecodeString())
			}
		default:
