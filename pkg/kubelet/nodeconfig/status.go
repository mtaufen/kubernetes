...
const (
	...
	curDefaultEffect = "using current (default)"
	curDefaultCause  = "current is set to the local default, and no init config was provided"

	curInitEffect = "using current (init)"
	curInitCause  = "current is set to the local default, and an init config was provided"

	curRemoteEffectFmt = "using current (UID: %q)"
	curRemoteCause     = "passed all checks"
)
