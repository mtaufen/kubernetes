...
func (cc *KubeletConfigController) pokeConfigSourceWorker() {
	select {
...
func (cc *KubeletConfigController) syncConfigSource(client clientset.Interface, nodeName string) {
	select {
...
func (cc *KubeletConfigController) doSyncConfigSource(client clientset.Interface, source *apiv1.NodeConfigSource) (bool, string, error) {
	if source == nil {
...
func (cc *KubeletConfigController) checkpointConfigSource(client clientset.Interface, source checkpoint.RemoteConfigSource) (string, error) {
	uid := source.UID()
...
func (cc *KubeletConfigController) setCurrentConfig(source checkpoint.RemoteConfigSource) (bool, string, error) {
...
func (cc *KubeletConfigController) resetConfig() (bool, string, error) {
