...
func (cc *KubeletConfigController) onAddNodeEvent(newObj interface{}) {
...
func (cc *KubeletConfigController) onUpdateNodeEvent(oldObj interface{}, newObj interface{}) {
...
func (cc *KubeletConfigController) onDeleteNodeEvent(deletedObj interface{}) {
