...
func signerFromRSAPrivateKey(keyPair *rsa.PrivateKey) (jose.Signer, error) {
	...
	// IMPORTANT: If this function is updated to support additional RSA key sizes,
	// algorithmForPublicKey in serviceaccount/util.go must also be updated to
	// support the same key sizes. Today we only support RS256.
