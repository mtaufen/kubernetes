			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"nonMasqueradeCIDRs": {
							SchemaProps: spec.SchemaProps{
								Description: "nonMasqueradeCIDRs configures masquerading: traffic to IPs outside these ranges (plus NonMasqueradeCIDR) will use IP masquerade.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
