...
func autoConvert_v1_NodeConfigSource_To_api_NodeConfigSource(in *NodeConfigSource, out *api.NodeConfigSource, s conversion.Scope) error {
...
func Convert_v1_NodeConfigSource_To_api_NodeConfigSource(in *NodeConfigSource, out *api.NodeConfigSource, s conversion.Scope) error {
	return autoConvert_v1_NodeConfigSource_To_api_NodeConfigSource(in, out, s)
}

func autoConvert_api_NodeConfigSource_To_v1_NodeConfigSource(in *api.NodeConfigSource, out *NodeConfigSource, s conversion.Scope) error {
...
func Convert_api_NodeConfigSource_To_v1_NodeConfigSource(in *api.NodeConfigSource, out *NodeConfigSource, s conversion.Scope) error {
...
func autoConvert_api_NodeSpec_To_v1_NodeSpec(in *api.NodeSpec, out *NodeSpec, s conversion.Scope) error {
	...
	out.ConfigSource = (*NodeConfigSource)(unsafe.Pointer(in.ConfigSource))
	return nil
}
