...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_NodeConfigSource, InType: reflect.TypeOf(&NodeConfigSource{})},
...
// DeepCopy_api_NodeConfigSource is an autogenerated deepcopy function.
func DeepCopy_api_NodeConfigSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*NodeConfigSource)
		out := out.(*NodeConfigSource)
		*out = *in
		if in.ConfigMapRef != nil {
			in, out := &in.ConfigMapRef, &out.ConfigMapRef
			*out = new(ObjectReference)
		...
		*out = *in
		...
		if in.ConfigSource != nil {
			...
			*out = new(NodeConfigSource)
			if err := DeepCopy_api_NodeConfigSource(*in, *out, c); err != nil {
				return err
			}
		}
		return nil
